export const timelineEvents = [
  ...
  {
    dateRange: {
      start: new Date(2025, 3, 29), // April 29
      end: new Date(2025, 4, 1), // May 1
    },
    markdownFile: "update6.md",
  },
  {
    dateRange: {
      start: new Date(2025, 4, 28), // May 28
      end: new Date(2025, 4, 30), // May 30
    },
    markdownFile: "update7.md",
  },
  {
    dateRange: {
      start: new Date(2025, 5, 24), // June 24
      end: new Date(2025, 5, 26), // June 26
    },
  },
];
